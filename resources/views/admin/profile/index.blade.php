                            ...
                            <div role="tabpanel" class="tab-pane active" id="profile_with_icon_title">
                                <form  class="form-horizontal" method="post" action="{{ route('admin.profile.update') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row custom-form-group custom-form-group-photo">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="file" class="form-control dropify" data-default-file="{{asset('uploads/avatar.png')}}" name="photo" value="{{old('photo')}}">
                                        </div>
                                        <div class="col-sm-6">
                                            @if(Auth::user()->photo != '')
                                                <img class="table-img-100" src="{{asset('uploads/'.Auth::user()->photo)}}" alt="Photo">
                                            @else
                                                <img class="table-img-100" src="{{asset('uploads/avatar.png')}}" alt="Photo">
                                            @endif
                                        </div>
                                    </div>
